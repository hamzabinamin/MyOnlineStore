...
$dynamicList = "";
$sql = oci_parse($conn,"select p.Product_id,p.name,Price,Color,Processor 
from product p,Laptop l
where p.product_id = l.product_id AND processor = 'Core i7' ");
...
<li><a href="http://localhost/MyOnlineStoreOwn/product_list_HTC.php"> HTC </a> </li>
   ...
   &nbsp;&nbsp;<input type="submit" name="sprice" value="Go" >
      ...
      <p>&nbsp;</p>
      <p>&nbsp;</p></td>
    <td width="80%" valign="top"><p align="center"> <strong>Core i7 Laptops List</strong></p>
