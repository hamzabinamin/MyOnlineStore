...
$dynamicList = "";
$sql = oci_parse($conn,"select p.Product_id,p.name,Price,Color,RAM 
from product p,Mobile_Phone m
where p.product_id = m.product_id AND RAM = '4 GB' ");
...
<title>4GB RAM Mobile Phones</title>
...
<li><a href="http://localhost/MyOnlineStoreOwn/product_list_HTC.php"> HTC </a> </li>
   ...
   &nbsp;&nbsp;<input type="submit" name="sprice" value="Go" >
      ...
      <p>&nbsp;</p>
      <p>&nbsp;</p></td>
    <td width="80%" valign="top"><p align="center"> <strong>4-GB RAM Mobile Phones </strong></p>
