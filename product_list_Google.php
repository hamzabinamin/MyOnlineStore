...
$dynamicList = "";
$sql = oci_parse($conn,"select Product_id,p.name,Price,Color,s.name 
from product p,supplier s
where p.supplier_id = s.supplier_id AND p.supplier_id = (select supplier_id from supplier s where s.name = 'Google')");
...
<title>Product List Google</title>
