...
where p.product_id = m.product_id AND RAM = '1 GB' ");
...
<title>1GB RAM Mobile Phones</title>
...
<li><a href="http://localhost/MyOnlineStoreOwn/product_list_HTC.php"> HTC </a> </li>
   ...
   &nbsp;&nbsp;<input type="submit" name="sprice" value="Go" >
      ...
      <p>&nbsp;</p>
      <p>&nbsp;</p></td>
    <td width="80%" valign="top"><p align="center"><strong>1-GB RAM Mobile Phones </strong></p>
