...
where p.product_id = t.product_id AND Screen_size = '9 inches' ");
...
<li><a href="http://localhost/MyOnlineStoreOwn/product_list_HTC.php"> HTC </a> </li>
   ...
   &nbsp;&nbsp;<input type="submit" name="sprice" value="Go" >
      ...
      <p>&nbsp;</p>
      <p>&nbsp;</p></td>
    <td width="80%" valign="top"><p align="center"> <strong>9 inch Tablets list </strong></p>
