...
$dynamicList = "";
$sql = oci_parse($conn,"select p.Product_id,p.name,Price,Color,Screen_size 
from product p,Tablet t
where p.product_id = t.product_id AND Screen_size = '7 inches' ");
...
<title>Product List 7 inches Tablets</title>
...
<li><a href="http://localhost/MyOnlineStoreOwn/product_list_HTC.php"> HTC </a> </li>
   ...
   &nbsp;&nbsp;<input type="submit" name="sprice" value="Go" >
      ...
      <p>&nbsp;</p>
      <p>&nbsp;</p></td>
    <td width="80%" valign="top"><p align="center"><strong>7 inch Tablets list </strong></p>
