...
where p.category_id = c.category_id AND p.category_id=(select category_id from category c where c.name = 'Laptops')
 ");
...
<title>Product List Laptops</title>
...
<li><a href="http://localhost/MyOnlineStoreOwn/product_list_HTC.php"> HTC </a> </li>
   ...
   &nbsp;&nbsp;<input type="submit" name="sprice" value="Go" >
      ...
      <p>&nbsp;</p>
      <p>&nbsp;</p></td>
    <td width="80%" valign="top"><p> <strong>Laptops List</strong></p>
